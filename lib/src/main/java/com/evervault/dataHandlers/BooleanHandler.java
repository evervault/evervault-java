...
stem        String formattedData = original ? "true" : "false";

        return encryptionProvider.encryptData(DataHeader.Boolean, generatedEcdhKey, formattedData.getBytes(StandardCharsets.UTF_8), sharedKey, teamPublicKey);
    }
}
