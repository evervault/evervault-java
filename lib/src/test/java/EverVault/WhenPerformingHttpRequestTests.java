...
public class WhenPerformingHttpRequestTests {
    ...
    @Test
    void additionalHeadersAreIncluded(WireMockRuntimeInfo wireMockRuntimeInfo) throws IOException, InterruptedException {
        final String endpoint = "/Foo";
    ...
    @Test
    void hittingCagePublicKeyEndpointParsesItCorrectly(WireMockRuntimeInfo wireMockRuntimeInfo) throws IOException, InterruptedException {
        var client = new HttpHandler(API_KEY);
